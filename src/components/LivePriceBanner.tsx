...
export const LivePriceBanner: React.FC<LivePriceBannerProps> = ({ currentTick, recentCandles }) => {
  ...
  return (
    <div className="bg-[#071426]/95 border-b border-[#00E5FF]/20 px-2 sm:px-3 py-1.5 sm:py-2 shadow-xs backdrop-blur-xl text-slate-100 relative overflow-hidden font-sans w-full max-w-full box-border min-w-0">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-1.5 sm:gap-3 relative z-10 w-full min-w-0 max-w-full">
        ...
        <div className="flex flex-row items-center gap-1.5 sm:gap-3 w-full md:w-auto justify-between md:justify-start min-w-0 max-w-full">
          <div className="flex items-center gap-1.5 sm:gap-2 shrink min-w-0">
            <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-[#00E5FF]/10 border border-[#00E5FF]/30 flex items-center justify-center text-[#00E5FF] shrink-0 shadow-[0_0_8px_rgba(0,229,255,0.15)]">
              <Layers className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#00E5FF] animate-pulse" />
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-1">
                ...
                <span className="text-[9px] sm:text-[10px] bg-[#00E5FF]/10 text-[#00E5FF] border border-[#00E5FF]/30 px-1.5 py-0.2 rounded-full font-mono font-bold uppercase tracking-wider whitespace-nowrap">
                  GOLD
                </span>
              </div>
        ...
        <div className="flex flex-wrap items-center gap-1 sm:gap-2 font-mono w-full md:w-auto justify-between md:justify-end min-w-0 max-w-full">
          ...
          <div className="grid grid-cols-3 gap-1 w-full sm:w-auto min-w-0">
            ...
            {/* 1. SPREAD Card */}
            <div className="bg-[#030B16]/80 border border-[#00E5FF]/20 px-1.5 py-1 rounded-lg shadow-xs text-center hover:border-[#00E5FF]/50 transition-colors min-w-0 overflow-hidden">
              <span className="text-[8px] sm:text-[9px] text-slate-400 uppercase tracking-wider font-extrabold block truncate">
                SPREAD
              </span>
              <span className="text-[10px] sm:text-xs font-bold text-[#00E5FF] block font-mono truncate">
                ${currentTick.spread.toFixed(2)}
              </span>
            </div>

            {/* 2. BID Card */}
            <div className="bg-[#030B16]/80 border border-[#00E5FF]/20 px-1.5 py-1 rounded-lg shadow-xs text-center hover:border-[#22C55E]/50 transition-colors min-w-0 overflow-hidden">
              <span className="text-[8px] sm:text-[9px] text-slate-400 uppercase tracking-wider font-extrabold block truncate">
            ...
            {/* 3. ASK Card */}
            <div className="bg-[#030B16]/80 border border-[#00E5FF]/20 px-1.5 py-1 rounded-lg shadow-xs text-center hover:border-[#EF4444]/50 transition-colors min-w-0 overflow-hidden">
              <span className="text-[8px] sm:text-[9px] text-slate-400 uppercase tracking-wider font-extrabold block truncate">
          ...
          <div className="hidden lg:flex items-center gap-2.5 bg-[#030B16]/80 border border-[#00E5FF]/20 p-1.5 rounded-xl shadow-xs">

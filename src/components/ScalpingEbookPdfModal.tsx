      ...
      <div className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 w-full max-w-4xl rounded-2xl border border-amber-500/30 shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col print:max-h-none print:shadow-none print:border-none print:rounded-none">
        ...
        <div className="p-4 bg-slate-900 text-white flex items-center justify-between border-b border-amber-500/30 shrink-0 print:hidden">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono font-bold text-sm sm:text-base text-amber-100">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-mono font-bold text-xs flex items-center gap-1.5 shadow-md transition-all cursor-pointer"
        ...
        <div className="p-6 sm:p-10 overflow-y-auto space-y-10 font-sans print:p-0 print:overflow-visible text-slate-800 dark:text-slate-200">
          
          {/* COVER PAGE / HEADER BANNER */}
          <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950 text-white rounded-2xl p-8 sm:p-12 border border-amber-500/40 shadow-xl relative overflow-hidden text-center space-y-4 print:rounded-none print:border-b-2 print:border-amber-500 print:bg-slate-950 print:text-white">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-mono font-bold bg-amber-500/20 text-amber-300 border border-amber-500/40">
              <Sparkles className="w-3.5 h-3.5 text-amber-400" />
              <span>MANUEL OFFICIEL D'UTILISATION & GUIDE DE TRADING</span>
            </div>

            <h1 className="text-2xl sm:text-4xl font-black font-mono text-amber-400 tracking-tight leading-tight">
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center gap-4 text-xs font-mono text-slate-400 border-t border-slate-800">
          ...
          {/* TABLE OF CONTENTS */}
          <div className="bg-slate-50 dark:bg-slate-950 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-3 font-mono print:border-slate-300">
          ...
          <section className="space-y-3 print:break-inside-avoid">
            <div className="flex items-center gap-2 border-b border-amber-500/30 pb-2">
              <span className="p-1.5 rounded-lg bg-amber-500/10 text-amber-600 dark:text-amber-400 font-mono font-black text-sm">01</span>
            ...
            <ul className="list-disc pl-5 text-xs sm:text-sm space-y-1 text-slate-600 dark:text-slate-300">
              ...
              <li><strong>Objectif :</strong> Capturer des mouvements de +25 à +50 pips avec un risque contrôlé de 10 à 15 pips.</li>
          ...
          <section className="space-y-3 print:break-inside-avoid">
            <div className="flex items-center gap-2 border-b border-amber-500/30 pb-2">
              <span className="p-1.5 rounded-lg bg-amber-500/10 text-amber-600 dark:text-amber-400 font-mono font-black text-sm">02</span>
              <h2 className="text-lg font-bold text-slate-900 dark:text-white font-mono">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-mono">
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-1">
                <span className="font-bold text-amber-600 dark:text-amber-400">1. Liquidity Sweep M1/M5</span>
                <p className="text-[11px] text-slate-500">Purge des Stops vendeurs ou acheteurs au-dessus/en-dessous des sommets/creux récents.</p>
              </div>
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-1">
                <span className="font-bold text-amber-600 dark:text-amber-400">2. Mitigation Order Block (OB)</span>
                <p className="text-[11px] text-slate-500">Rebond précis sur la zone de commande institutionnelle non testée.</p>
              </div>
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-1">
                <span className="font-bold text-amber-600 dark:text-amber-400">3. Corrélation Inverse DXY (Dollar)</span>
                <p className="text-[11px] text-slate-500">Baisse de l'Indice du Dollar américain confirmant la poussée haussière du XAU/USD.</p>
              </div>
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-1">
                <span className="font-bold text-amber-600 dark:text-amber-400">4. Alignement EMA 200 / Trend</span>
                <p className="text-[11px] text-slate-500">Trade pris strictement dans le sens du flux dynamique dominant M5/M15.</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3 print:break-inside-avoid">
            <div className="flex items-center gap-2 border-b border-amber-500/30 pb-2">
              <span className="p-1.5 rounded-lg bg-amber-500/10 text-amber-600 dark:text-amber-400 font-mono font-black text-sm">03</span>
              <h2 className="text-lg font-bold text-slate-900 dark:text-white font-mono">
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4 space-y-2 text-xs font-mono">
          ...
          <section className="space-y-3 print:break-inside-avoid">
            <div className="flex items-center gap-2 border-b border-amber-500/30 pb-2">
              <span className="p-1.5 rounded-lg bg-amber-500/10 text-amber-600 dark:text-amber-400 font-mono font-black text-sm">04</span>
              <h2 className="text-lg font-bold text-slate-900 dark:text-white font-mono">
            ...
            <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-800 text-xs font-mono space-y-1.5">
          ...
          <section className="space-y-3 print:break-inside-avoid">
            <div className="flex items-center gap-2 border-b border-amber-500/30 pb-2">
              <span className="p-1.5 rounded-lg bg-amber-500/10 text-amber-600 dark:text-amber-400 font-mono font-black text-sm">05</span>
              <h2 className="text-lg font-bold text-slate-900 dark:text-white font-mono">
            ...
            <ol className="list-decimal pl-5 text-xs sm:text-sm space-y-1.5 text-slate-600 dark:text-slate-300">
          ...
          {/* FOOTER SIGNATURE */}
          <div className="pt-6 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-slate-500 gap-2 print:border-t-2">
            <div>© 2026 ChrisXauusd Terminal Scalping Pro — Tous Droits Réservés</div>
            <div className="text-amber-600 dark:text-amber-400 font-bold">Trading Haute Précision XAU/USD</div>
          </div>

        </div>

        {/* Modal Footer Controls (Hidden when printing) */}
        <div className="p-4 bg-slate-100 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between shrink-0 print:hidden">
          <span className="text-xs font-mono text-slate-500 hidden sm:inline">
            💡 Astuce : Vous pouvez enregistrer ce livre directement au format PDF via la boîte de dialogue d'impression.
          </span>
          <button
            onClick={handlePrintPdf}
            className="ml-auto px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-mono font-bold text-xs flex items-center gap-2 cursor-pointer shadow-md"
          >

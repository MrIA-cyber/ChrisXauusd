      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                {/* Badge XAU/USD */}
                <span className="px-1.5 sm:px-2 py-0.5 rounded text-[9px] sm:text-[10px] font-mono font-bold bg-amber-500/10 text-amber-700 dark:text-amber-300 border border-amber-500/30 uppercase">
                  XAU/USD
                </span>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`p-2 rounded-xl text-xs transition-all active:scale-95 cursor-pointer border ${
          ...
          {onToggleTheme && (
            <button
              ...
              className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 transition-all active:scale-95 cursor-pointer"
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 px-2.5 py-2 rounded-xl text-xs font-mono font-bold transition-all active:scale-95 cursor-pointer"

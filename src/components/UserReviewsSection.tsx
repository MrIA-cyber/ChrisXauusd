...
export const UserReviewsSection: React.FC<UserReviewsSectionProps> = ({
  ...
  return (
    <section className="relative my-8 max-w-7xl mx-auto px-4 font-sans">
      {/* Container Box with Subtle Dark Glassmorphism */}
      <div className="bg-slate-900/90 border border-slate-800/90 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden backdrop-blur-xl">
        ...
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-800/80 pb-6 relative z-10">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-black font-mono text-white tracking-tight flex items-center gap-2">
          ...
          <div className="shrink-0 flex items-center gap-3">
            <button
              ...
              className="bg-slate-800/90 hover:bg-slate-700/90 text-amber-300 border border-amber-500/40 hover:border-amber-400 font-mono text-xs font-bold px-4 py-2.5 rounded-2xl shadow-md transition-all flex items-center gap-2 group transform active:scale-95"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 my-6 relative z-10">
          ...
          {/* Rating Big Card */}
          <div className="col-span-2 sm:col-span-1 bg-gradient-to-br from-amber-950/40 via-slate-900 to-slate-950 border border-amber-500/30 rounded-2xl p-4 flex flex-col items-center justify-center text-center shadow-inner">
            <div className="flex items-center gap-1 mb-1">
              <span className="text-3xl font-black font-mono text-amber-400">4.9</span>
          ...
          <div className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-3.5 flex flex-col justify-between">
            ...
            <div className="mt-2">
              <span className="text-xl font-bold font-mono text-white">1 450+</span>
          ...
          <div className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-3.5 flex flex-col justify-between">
            ...
            <div className="mt-2">
              <span className="text-xl font-bold font-mono text-emerald-400">98.4%</span>
          ...
          <div className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-3.5 flex flex-col justify-between">
            ...
            <div className="mt-2">
              <span className="text-xl font-bold font-mono text-amber-400">84.5%</span>
              <p className="text-[10px] text-slate-400 font-mono mt-0.5">
          ...
          <div className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-3.5 flex flex-col justify-between col-span-2 sm:col-span-1">
            <div className="flex items-center justify-between text-slate-400">
              <span className="text-[11px] font-mono uppercase font-semibold">Signaux Émis</span>
              <ShieldCheck className="w-4 h-4 text-purple-400" />
            </div>
            <div className="mt-2">
              <span className="text-xl font-bold font-mono text-white">3 200+</span>
              <p className="text-[10px] text-slate-400 font-mono mt-0.5">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 relative z-10">
          ...
          <div className="flex items-center gap-2 shrink-0 self-end sm:self-auto font-mono text-xs">
            ...
            <button
              onClick={handlePrev}
              className="w-9 h-9 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 flex items-center justify-center text-slate-300 hover:text-white transition-all active:scale-95"
        ...
        >
          {filteredReviews.length > 0 ? (
              ...
              {[0, 1, 2].map((offset) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-gradient-to-b from-slate-950/90 to-slate-950/60 border rounded-2xl p-5 flex flex-col justify-between shadow-lg hover:shadow-2xl transition-all duration-300 group ${
                      offset === 0 ? 'border-amber-500/40' : 'border-slate-800/80 hover:border-slate-700'
                    }`}
                  >
                    <div>
                      ...
                      <div className="flex items-start justify-between gap-2 mb-3">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-amber-400/20 via-amber-500/20 to-blue-600/20 border border-slate-700 flex items-center justify-center text-amber-400 font-mono font-bold text-sm shadow-sm group-hover:border-amber-500/50 transition-colors">
                        ...
                        {/* Verified Badge */}
                        <span
                          className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded-full border flex items-center gap-1 shrink-0 ${review.badgeColor}`}
                        >
                    ...
                    <div className="flex items-center justify-between border-t border-slate-800/80 pt-3 text-[11px] font-mono text-slate-400">
                      ...
                      >
                        <ThumbsUp className={`w-3 h-3 ${likedReviews[review.id] ? 'fill-current' : ''}`} />
            ...
            <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-8 text-center text-slate-400 font-mono text-xs">
        ...
        <div className="mt-8 pt-6 border-t border-slate-800/80 grid grid-cols-2 sm:grid-cols-4 gap-3 text-center text-xs font-mono text-slate-300 relative z-10">
          <div className="flex items-center justify-center gap-2 bg-slate-950/50 p-2.5 rounded-xl border border-slate-800/60">
        ...
        {isSubmitModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
            <motion.div
              ...
              className="bg-slate-900 border border-amber-500/40 rounded-3xl p-6 sm:p-8 max-w-lg w-full shadow-2xl relative overflow-hidden font-sans text-slate-100"
            >
              {/* Header */}
                ...
                <form onSubmit={handleSubmitReview} className="space-y-4 text-xs font-mono">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-slate-100 placeholder-slate-500 focus:outline-none focus:border-amber-500/60 font-sans"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-slate-100 focus:outline-none focus:border-amber-500/60 font-sans"
                    >
                      <option value="🇨M Cameroun">🇨🇲 Cameroun</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-slate-100 placeholder-slate-500 focus:outline-none focus:border-amber-500/60 font-sans text-xs leading-relaxed resize-none"
                    />
                  </div>
                  ...
                  <div className="pt-2">
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-300 hover:to-amber-500 text-slate-950 font-mono font-bold py-3 px-4 rounded-xl text-xs shadow-lg shadow-amber-500/20 active:scale-98 transition-all flex items-center justify-center gap-2"
                    >
